...
def adjacent_stations(gd: gt.GD, n: Network, company_name: str, station_name: str, line_code: str,
                      *adjacent_station_names: list[str], company_type: type[gt.Node] = gt.RailCompany):
